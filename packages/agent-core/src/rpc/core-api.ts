...
export interface ExportSessionPayload {
  ...
  /**
   * When true, the active global diagnostic log (`$LMCODE_HOME/logs/lmcode.log`)
   * is copied into the zip at `logs/global/lmcode.log`. Off by default to

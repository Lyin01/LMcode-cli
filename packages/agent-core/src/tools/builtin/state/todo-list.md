...
- For requirement tracking, preserve individual details as separate items (e.g. "Keep existing API", "Preserve parenthetical condition", "Do not touch generated files", "Verify typecheck").

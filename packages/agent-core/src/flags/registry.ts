 ...
 * autocomplete and typo-checking. `env` must start with 'LMCODE_EXPERIMENTAL_', be unique, and
 * not equal the master switch 'LMCODE_EXPERIMENTAL_FLAG'; `id` must not be 'flag'.
 */

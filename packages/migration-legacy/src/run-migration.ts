...
const CONFIG_CONFLICT_NOTICE =
  'Your existing config.toml could not be parsed; migrated copy saved to ~/.lmcode/config.migrated-from-scream-cli.toml — please review and merge manually.';

const TUI_CONFLICT_NOTICE =
  'Your existing tui.toml had user modifications; migrated copy saved to ~/.lmcode/tui.migrated-from-scream-cli.toml — please review and merge manually.';

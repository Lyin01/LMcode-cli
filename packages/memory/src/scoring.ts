...
export function extractKeywords(text: string): string[] {
  ...
  for (const part of parts) {
    ...
    // For CJK text, emit single characters (recall) plus adjacent bigrams.
    // Character-level Jaccard alone gives false positives in Chinese: unrelated
    // terms sharing common characters (存/优/化…) score as similar. Bigrams

...
function createProvider(): LmcodeChatProvider {
...
describe('LmcodeFiles', () => {
  ...
  describe('exposure on LmcodeChatProvider', () => {
    it('exposes files property returning a LmcodeFiles instance', () => {
      const provider = createProvider();
      const files = provider.files;
      expect(files).toBeInstanceOf(LmcodeFiles);

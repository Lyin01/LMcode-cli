  ...
  return {
    ...
    LmcodeHarness: class {
      ...
      constructor(...args: unknown[]) {
        ...
        this.homeDir = options?.homeDir ?? '/tmp/lmcode-export-home';
...
beforeEach(() => {
  tmp = mkdtempSync(join(tmpdir(), 'lmcode-export-'));
});
...
afterEach(() => {
  ...
  mocks.resolveLmcodeHome.mockImplementation(
    (homeDir?: string) => homeDir ?? '/tmp/lmcode-export-home',
  );

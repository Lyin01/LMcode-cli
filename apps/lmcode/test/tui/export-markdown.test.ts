...
import type { ContentPart, ToolCall } from '@lmcode-cli/lmcode-sdk';
import type { ContextMessage, PromptOrigin } from '@lmcode-cli/lmcode-sdk';
...
describe('buildExportMarkdown', () => {
  ...
  it('builds complete markdown with frontmatter and overview', () => {
    ...
    expect(md).toContain('# LMcode 会话导出');

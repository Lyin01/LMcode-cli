...
import { LmcodeTUI, type LmcodeTUIStartupInput } from '#/tui/lmcode-tui';
...
function makeStartupInput(): LmcodeTUIStartupInput {
  return {
    cliOptions: {
      session: undefined,
      continue: false,
...
function makeDriver(): { driver: SignalDriver; tui: LmcodeTUI } {
  const tui = new LmcodeTUI(makeHarness() as never, makeStartupInput());
...
describe('LmcodeTUI signal handlers', () => {

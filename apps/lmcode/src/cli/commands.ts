...
export function createProgram(
  ...
  // cc-connect spawns: lm stream-json --output-format stream-json --input-format stream-json
  ...
  // `lm channel setup` — interactive cc-connect platform configuration wizard.

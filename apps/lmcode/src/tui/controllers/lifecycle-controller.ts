import type { Session, LmcodeHarness } from '@lmcode-cli/lmcode-sdk';
...
import { createLmcodeTUIThemeBundle } from '../theme/bundle';
...
export class LifecycleController {
  ...
  applyTheme(theme: Theme, resolved?: ResolvedTheme): void {
    const nextTheme = createLmcodeTUIThemeBundle(theme, resolved);

...
import type { ApprovalRequest, ApprovalResponse } from '@lmcode-cli/lmcode-sdk';
...
export class TranscriptController {
  ...
  // Package-visible helpers for LmcodeTUI to reach specific components.

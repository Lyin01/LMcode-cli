...
export interface LmcodeTUIStartupInput {
...
export class LmcodeTUI implements TranscriptControllerHost, LifecycleControllerHost, InputControllerHost {
  readonly harness: LmcodeHarness;
  readonly options: LmcodeTUIOptions;
  ...
  constructor(harness: LmcodeHarness, startupInput: LmcodeTUIStartupInput) {
    this.harness = harness;
    const tuiOptions: LmcodeTUIOptions = {
  ...
  setAppState(patch: Partial<AppState>): void {
    ...
    if ('thinkingLevel' in patch) {
      this.state.editor.thinking = patch.thinkingLevel !== undefined && patch.thinkingLevel !== 'off';
    }
